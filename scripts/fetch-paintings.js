...
const TITLE_JA = {
  ...
  'Judge (Qazi) of Hamadan in a Drunken State, a scene from the Gulistan of Sa\'di':'「ゴレスターン」より　酔ったハマダーンの裁判官',
  'Poetry Fragment (Qit\'a) written in Nasta\'liq Script':'ナスタアリーク体で書かれた詩篇断簡',
  'Fisherman\'s Cottage':'漁師の小屋',
  'Farm near Duivendrecht':'ダイフェンドレヒト近郊の農場',
  'Day (Truth)':'昼（真実）',
  'A Sunday on La Grande Jatte — 1884':'グランド・ジャット島の日曜日の午後　1884年',
  'Stacks of Wheat (End of Day, Autumn)':'積み藁（秋、夕暮れ）',
  'Improvisation No. 30 (Cannons)':'即興第30番（大砲）',
  'Lozenge Composition with Yellow, Black, Blue, Red, and Gray':'黄色・黒・青・赤・灰色の菱形コンポジション',
  'Cliff Walk at Pourville':'プールヴィルの断崖の散歩道',
  'The Beach at Sainte-Adresse':'サント＝アドレスの浜辺',
  'Arrival of the Normandy Train, Gare Saint-Lazare':'サン＝ラザール駅、ノルマンディー行き列車の到着',
  'Young Woman at an Open Half-Door':'半開きの扉のそばの若い女性',
  'Odalisque':'オダリスク',
  'The Fountain, Villa Torlonia, Frascati, Italy':'イタリア、フラスカーティのヴィラ・トルロニアの噴水',
  'Apples':'りんご',
  'Woman on Rose Divan':'ばら色の長椅子の女',
  'The Bay of Marseille, Seen from L\'Estaque':'レスタックから見たマルセイユ湾',
  'Landscape with the Ruins of the Castle of Egmond':'エグモント城跡のある風景',
  'Interior of St. Mark\'s, Venice':'ヴェネツィア、サン・マルコ寺院の内部',
  'The Winter Sun':'冬の太陽',
  'The Prairie on the River Platte':'プラット川の草原',
  'The Old Hunting Grounds':'古い狩猟場',
  'Autumn on the Hudson River':'ハドソン川の秋',
  'Lake George':'ジョージ湖',
  'The Last of the Buffalo':'最後のバッファロー',
  'Icebergs (The North Pole)':'氷山（北極）',
  'A Winter Scene in the Catskills':'キャッツキルの冬景色',
  'The Wolf Charmer':'狼使い',
  'Peasant Gathering Potatoes':'じゃがいもを集める農民',
  'Shepherdess Knitting':'編み物をする羊飼いの娘',
  'Young Shepherdess':'若い羊飼いの娘',
  'Seated Young Peasant':'座る若い農民',
  'Peasant Girl with Bare Feet':'裸足の農家の少女',
  'Shepherdess Lying on the Ground':'地面に横たわる羊飼いの娘',
  'The Quilting Bee':'キルトづくりの集い',
  'Preparing Cotton for Market':'市場出荷のための綿の準備',
  'Portrait of a Young Man in a Feathered Hat':'羽根帽子の若い男の肖像',
  'Procession of the Trojan Horse into Troy':'トロイへの木馬の行進',
  'Lamentation over the Dead Christ':'死せるキリストを悼む',
  'A Vase of Flowers on a Pedestal':'台座の上の花瓶の花',
  'Flowers in a Terracotta Vase':'テラコッタの花瓶の花',
  'Iris, Tulips, Poppies, and Violets':'アイリス、チューリップ、ポピー、スミレ',
  'Vase of Flowers with Insects':'虫のいる花瓶の花',
  'Bunch of Flowers with Shells, Coins, Medals, and Statuette':'貝殻、コイン、メダル、小像を添えた花束',
  'Young Woman Picking Fruit':'果実を摘む若い女性',
  'Portrait of Mrs. William Cox Wright (Mary Wharton)':'ウィリアム・コックス・ライト夫人の肖像',
  'On the Wings of the Morning':'朝の翼に乗って',
  'Seascape with a Ship':'船のある海景',
  'The Minstrel':'吟遊詩人',
  'Landscape with a Lake':'湖のある風景',
  'The Passing Storm':'通り過ぎる嵐',
  'A Turk':'トルコ人',
  'The Woodgatherer':'薪を集める人',
  'The Cottage':'小屋',
  'The Drinker':'酒飲み',
  'The Pet Bird':'飼い鳥',
  'The Dancer':'踊り子',
  'The Parasol':'日傘',
  'The Way to School':'学校への道',
  'Winter Afternoon':'冬の午後',
  'Mount Hood':'フッド山',
  'A River Estuary':'川の河口',
  'In the Shade of the Poplars':'ポプラの木陰で',
  'The Artist\'s Garden in Argenteuil (A Corner of the Garden with Dahlias)':'アルジャントゥイユの画家の庭（ダリアのある庭の一角）',
  'The Seine at Argenteuil':'アルジャントゥイユのセーヌ川',
  'Grain Stacks (End of Summer)':'積み藁（夏の終わり）',
  'Meadow at Giverny':'ジヴェルニーの草地',
  'The Haystacks (End of Summer, Morning Effect)':'積み藁（夏の終わり、朝の効果）',
  'The Rock Needle and the Porte d\'Aval, Étretat':'エトルタ、岩の針とポルト・ダヴァル',
  'The Manneporte, Étretat':'エトルタのマンヌポルト',
  'The Cliff, Étretat, after the Storm':'嵐の後のエトルタの断崖',
  'Green Park, London':'ロンドン、グリーン・パーク',
  'Evening on the Thames, near Putney':'パトニー近く、テムズ川の夕べ',
  'London Bridge':'ロンドン橋',
  'Antibes (Afternoon Effect)':'アンティーブ（午後の効果）',
  'Cap d\'Antibes, Mistral':'カップ・ダンティーブ、ミストラル',
  'Antibes Seen from the Salis':'サリスから見たアンティーブ',
  'The Sea at Les Saintes-Maries-de-la-Mer':'レ・サント＝マリーの海',
  'Oleanders':'キョウチクトウ',
  'Farmhouse in Provence':'プロヴァンスの農家',
  'The Starry Night over the Rhône':'ローヌ川の上の星月夜',
  'The Sower (after Millet)':'種まく人（ミレーによる）',
  'The Olive Trees':'オリーブの木々',
  'Wheat Field':'麦畑',
  'Wheat Field with Crows':'カラスのいる麦畑',
  'Portrait of Père Tanguy':'タンギー爺さんの肖像',
  'The Sacred Grove, Beloved of the Arts and the Muses':'芸術とミューズに愛された聖なる森',
  'The White Tablecloth':'白いテーブルクロス',
  'Still Life: Corner of a Table':'静物　テーブルの一隅',
  'Virgil Reading the Aeneid to Augustus, Octavia, and Livia':'ウェルギリウス、アエネイスをアウグストゥスたちに読む',
  'Cattle at Rest on a Hillside in the Alps':'アルプスの丘で休む牛',
  'Landscape with a Herdsman and Goats':'羊飼いと山羊のいる風景',
  'Winged Figure':'翼ある人物',
  'The Seine at Port-Marly, Piles of Sand':'ポール＝マルリーのセーヌ川、砂の山',
  'The Cottage by the Roadside, Stormy Sky':'道端の小屋、嵐空',
  'Magnolias on Light Blue Velvet Cloth':'淡い青のビロード布の上のモクレン',
  'Mahana no atua (Day of the God)':'マハナ・ノ・アトゥア（神の日）',
  'Arlésiennes (Mistral)':'アルルの女たち（ミストラル）',
  'No te aha oe riri (Why Are You Angry?)':'ノ・テ・アハ・オエ・リリ（なぜ怒っているの？）',
  'Polynesian Woman with Children':'子どもたちを連れたポリネシアの女',
  'In the Auvergne':'オーヴェルニュにて',
  'The Woodchopper':'木を切る人',
  'The Little Shepherdess':'小さな羊飼いの娘',
  'The Sheepshearers':'羊の毛を刈る人々',
  'Peasants Bringing Home a Calf Born in the Fields':'野で生まれた子牛を連れ帰る農民たち',
  'The Keeper of the Flock':'羊番',
  'Virgin and Child with an Angel':'天使を伴う聖母子',
  'Virgin and Child with Two Angels':'二人の天使を伴う聖母子',
  'Distant View of Niagara Falls':'遠望のナイアガラ滝',
  'Madame Cézanne (Hortense Fiquet, 1850-1922) in a Red Dress':'赤いドレスのセザンヌ夫人',
  'Mont Sainte-Victoire and the Viaduct of the Arc River Valley':'サント＝ヴィクトワール山とアルク渓谷の高架橋',
  'The Large Bathers':'大水浴図',
  'The Sea at L\'Estaque':'レスタックの海',
  'Daughters of the Fields (The Haymakers)':'野の娘たち（干し草を刈る人々）',
  'After the Bath, Woman Drying Herself':'浴後、身体を拭く女',
  'Before the Race':'競走前',
  'Rearing Horse and Fallen Jockey':'跳ね上がる馬と落馬した騎手',
  'Four Dancers':'四人の踊り子',
  'Dancers, Pink and Green':'踊り子たち、ピンクと緑',
  'Three Studies of a Dancer in Fourth Position':'第四ポジションの踊り子の三習作',
  'End of the Arabesque':'アラベスクの終わり',
  'At the Milliner\'s':'帽子屋にて',
  'Before the Ballet':'バレエの前',
  'The Portrait of a Lady with a Carnation':'カーネーションを持つ婦人の肖像',
  'Lady at the Virginals with a Gentleman':'ヴァージナルを弾く婦人と紳士',
  'Study of Trees':'木々の習作',
  'Sketch for Ploughing in the Nivernais':'「ニヴェルネー地方の耕作」のための習作',
  'The Return from Pasture (Evening)':'牧場からの帰り（夕暮れ）',
  'Boy Chasing a Dragonfly':'トンボを追う少年',
  'The Shearing of the Sheep':'羊の毛刈り',
  'Evening in the Meadow':'草地の夕べ',
  'Field of Grain':'穀物畑',
  'Young Girls Running Along the River Bank':'川岸を走る若い娘たち',
  'A Farm in Brittany':'ブルターニュの農場',
  'A Farm in Normandy':'ノルマンディーの農場',
  'Normandy Landscape':'ノルマンディーの風景',
  'The Knitters':'編み物をする女たち',
  'The Hen and Her Chickens':'雌鶏とひよこたち',
  'Resting':'休息',
  'A Farm in Picardy':'ピカルディの農場',
  'Picardy Landscape':'ピカルディの風景',
  'Old Peasant Woman':'老いた農婦',
  'Head of an Old Man':'老人の頭部',
  'Head of a Peasant Woman':'農婦の頭部',
  'A Corner of the Studio':'アトリエの一隅',
  'The Morning of the Nativity':'降誕の朝',
  'La Tour de l\'Horloge, Rouen':'ルーアンの時計塔',
  'The Walled Garden':'囲い庭',
  'Mont Sainte-Victoire Seen from Bibémus':'ビベミュスから見たサント＝ヴィクトワール山',
  'Bibémus Quarry':'ビベミュス採石場',
  'Houses in Provence: The Riaux Valley near L\'Estaque':'プロヴァンスの家々、レスタック近くのリオー谷',
  'In the Woods':'森の中で',
  'The Wood Chopper':'木を割る人',
  'Hebe':'ヘベ',
  'Morning in New England':'ニューイングランドの朝',
  'Fir Trees and Storm Clouds':'モミの木と嵐雲',
  'Portrait of Ezra Davenport':'エズラ・ダヴェンポートの肖像',
  'High Tide on the Marshes':'湿地の満潮',
  'The Offering':'捧げもの',
  'Spring on the Hillside':'丘の斜面の春',
  'Labrador Coast':'ラブラドール海岸',
  'Portrait of the Artist\'s Mother (Lydia Wardwell Smith)':'画家の母（リディア・ウォードウェル・スミス）の肖像',
  'Over the Dunes, Cape Cod, Massachusetts':'マサチューセッツ州ケープコッド、砂丘の向こう',
  'Washerwomen at Goyen':'ゴワイヤンの洗濯女たち',
  'Italian Night, Capri':'カプリのイタリアの夜',
  'Gray Day on the Bay':'湾の灰色の日',
  'Harvest on the Roman Campagna':'ローマのカンパーニャの収穫',
  'Christ':'キリスト',
  'Mount Washington, New Hampshire':'ニューハンプシャー州ワシントン山',
  'The Stubble Field':'刈り跡の畑',
  'Sweeping Snow':'吹き払われる雪',
  'My First View of the Congo Forest':'私が初めて見たコンゴの森',
  'In the Sand-pit':'砂場にて',
  'The Studio Table':'アトリエの机',
  'Montclair, New Jersey':'ニュージャージー州モントクレア',
  'Primrose':'サクラソウ',
  'Pointe de Cabellou, Brittany':'ブルターニュ、カベルー岬',
  'Disturbed':'動揺',
  'A Philosopher':'哲学者',
  'Fleecy Clouds':'羊毛のような雲',
  'Marine':'海景',
  'Indian Camp':'インディアンの野営地',
  'Edge of the Woods':'森のはずれ',
  'The Road to the Sea':'海への道',
  'June Day':'六月の日',
  'Mrs. Goss (The Woman in Fur)':'ゴス夫人（毛皮の女）',
  'The White Mists of Niagara':'ナイアガラの白い霧',
  'Flowers and Fruit':'花と果物',
  'A Fisherman\'s Hut':'漁師小屋',
  'Old Houses at Dordrecht':'ドルドレヒトの古い家々',
  'A Haunt of the Wild Goose':'雁のすみか',
  'The Approaching Storm':'迫り来る嵐',
  'A Connecticut Farm':'コネチカットの農場',
  'New York Harbor from Staten Island':'スタテン島から見たニューヨーク港',
  'Annisquam Harbor, Cape Ann, Massachusetts':'マサチューセッツ州ケープアン、アニスクアム港',
  'Head of a Boy (possibly David Teniers III)':'少年の頭部（おそらくダフィット・テニールス三世）',
  'Nocturne (detail)':'夜想曲（部分）',
  'House Among the Trees':'木立の中の家',
  'Trees in Autumn':'秋の木々',
  'Still Life—Vessel of Flowers':'静物　花の器',
  'Nocturne':'夜想曲',
  'Nocturne: Battersea Bridge':'夜想曲　バタシー橋',
